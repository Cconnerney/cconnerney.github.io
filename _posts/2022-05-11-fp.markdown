...
description: Using two techniques to analyze free text documents: a bag of words approach based on a TFIDF matrix and an n-gram language model. The Federalist papers were a series of essays written in 1787 and 1788
