...
<li>Machine Learning Modeling – Neural Network, HMM, Logistic Regression, Collaborative Filtering Matrix Factorization, Content-Based Recommender Systems, Reinforcement Learning, Q-Learning, Lemmatization, N-Gram, KNN, Perceptron</li>
